...
(1, 3, 'abcd', 'Nivin', 'This story revolves around a student political leader who fights for his left-wing ideals. When some people try to use him in order to fulfill their intentions, he is forced to fight for his ideals.', '2018-01-01', 'images/maxresdefault.jpg', 'https://www.youtube.com/watch?v=x_AK7HWpJ-0', 0),
(2, 3, 'Comarade In America', 'Dulquer Salmaan', 'Aji Mathew is a lovable, courageous, and modest youngster who hails from Pala. He meets a girl named Sara at college, and they fall in love regardless of their upbringing.', '2019-05-05', 'images/cia-new-poster-759.jpeg', 'https://www.youtube.com/watch?v=f5nvCp0QFdA', 0),
(3, 3, 'Angamaly Diaries', ' Reshma Rajan, Tito Wilson, Sarath Kumar', 'Angamaly Diaries is a 2017 Indian Malayalam-language crime drama film directed by Lijo Jose Pellissery and written by Chemban Vinod Jose.', '2019-05-01', 'images/angamaly-diaries-2.jpg', 'https://www.youtube.com/watch?v=4yRBJCrjabU', 0),
(8, 3, 'Godha', 'Tovino Thomas, Wamiqa Gabbi ', 'Godha is an Malayalam Sports-Comedy movie directed by Basil Joseph, starring Tovino Thomas, Wamiqa Gabbi and Renji Panicker in the lead roles', '2019-05-19', 'images/godha.jpg', 'https://www.youtube.com/watch?v=hnICGugY6fI', 0),
(10, 3, 'Ramante Edanthottam', 'Kunchacko Boban, Anu Sithara', 'Ramante Edanthottam is an upcoming Malayalam language film written produced and directed by Ranjith Shankar.', '2019-05-12', 'images/raman.jpg', 'https://www.youtube.com/watch?v=H6HK51qVdmc', 0),
(5, 4, 'kalank', 'Sanjay Dutt as Balraj Chaudhry','Set in 1945, in Pre-Independence India, Kalank is a tale of eternal love.','2019-04-17','images/kalank.jpg','https://www.youtube.com/watch?v=p4Z_ueeT_XQ',0);
-- --------------------------------------------------------
...
(1, 9, 4, 1, '2019-05-01', 1, 1),
(2, 10, 4, 1, '2019-05-01', 1, 1),
(3, 11, 4, 2, '2019-05-01', 1, 1),
(4, 12, 4, 2, '2019-05-01', 1, 1),
(5, 1, 3, 1, '2019-05-01', 1, 1);
...
(2, 'balaji', 'hyderabad', 'hyderabad', 'Ap', 691523),
(3, 'viva', 'jalandhar', 'jalandhar', 'punjab', 691523),
(4, 'Smitha', 'Adoor', 'adoor', 'Kerala', 691523),
(5, 'pvr', 't-nagar', 'xyz', 'tamilnadu', 691523),
